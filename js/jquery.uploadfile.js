	...
	this.enqueueFile = function(file){
        ...
        function createCustomInputFile (obj, group, s, uploadLabel) {
            ...
            if(s.multiple) {
                ...
                fileInputStr = "<input type='file' id='" + fileUploadId + "' name='" + "photograph" + "' accept='" + s.acceptFiles + "' multiple/>";
            }
		...
		function defaultProgressBar(obj,s)
		{
			...
			this.statusbar = $("<div class='ajax-file-upload-statusbar custom_statusbar'></div>").width(s.statusBarWidth);
            this.preview = $("<img class='ajax-file-upload-preview custom_preview' />").width(s.previewWidth).height(s.previewHeight).appendTo(this.statusbar).hide();
            this.filename = $("<div class='ajax-file-upload-filename custom_filename'></div>").appendTo(this.statusbar);
            ...
            this.del.addClass("ajax-file-upload-red custom_del");
